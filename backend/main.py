...
# Use custom CORSMiddleware that ignores Socket.io to avoid duplicate headers
...
# Private network header handled separately if needed, but standard CORS usually covers it
@app.middleware("http")
