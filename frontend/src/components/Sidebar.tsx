    ...
    return (
        <>
            ...
            <motion.div
                ...
                // On mobile, force width to be constant (w-72) or handle visibility via transform
                // We'll use CSS transform for mobile show/hide to avoid Framer Motion conflict with desktop width animation
                className={cn(
                    "fixed top-0 left-0 bottom-0 lg:top-6 lg:bottom-6 lg:left-6 flex flex-col z-[100] transition-all duration-500 overflow-hidden",
                    "bg-background/95 backdrop-blur-2xl border-r lg:border border-white/50 shadow-2xl shadow-orange-900/10",
                    "lg:rounded-[3rem]", /* Rounded only on desktop */
