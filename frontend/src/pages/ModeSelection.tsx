...
const ModeSelection = () => {
    ...
    return (
        <div className="h-screen flex items-center justify-center bg-[#FFF8F5] p-4 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-[#FFF8F5] via-[#FFF8F5] to-[#F5F3FF] pointer-events-none" />

            {/* Soft Peachy-Purple Blossoms */}
            <motion.div
                animate={{ scale: [1, 1.2, 1], rotate: [0, 90, 0] }}
                transition={{ duration: 20, repeat: Infinity }}
                className="absolute -top-20 -right-20 w-96 h-96 bg-purple-100/50 rounded-full blur-[100px]"
            />
            <motion.div
                animate={{ scale: [1, 1.3, 1], x: [0, 50, 0] }}
                transition={{ duration: 15, repeat: Infinity }}
                className="absolute -bottom-20 -left-20 w-80 h-80 bg-orange-100/50 rounded-full blur-[80px]"
            />
            ...
            <div className="z-10 w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                    ...
                    <div className="relative h-[500px] bg-card border border-border rounded-3xl p-8 flex flex-col justify-between overflow-hidden hover:scale-[1.02] transition-transform duration-300">
                        <div className="absolute top-0 right-0 p-32 bg-pink-500/10 rounded-full blur-3xl -mr-16 -mt-16" />
                        ...
                        <div>
                            ...
                            <h2 className="text-4xl font-display font-bold mb-4">Home Mode</h2>
                            <p className="text-muted-foreground text-lg">
                                Focus on personal well-being, cycle tracking, and nutritional balance.
                            </p>
                        </div>

                        <div className="flex items-center gap-2 text-pink-500 font-semibold group-hover:translate-x-2 transition-transform">
                ...
                >
                    ...
                    <div className="relative h-[500px] bg-card border border-border rounded-3xl p-8 flex flex-col justify-between overflow-hidden hover:scale-[1.02] transition-transform duration-300">
                        ...
                        <div>
                            ...
                            <h2 className="text-4xl font-display font-bold mb-4">Work Mode</h2>
                            <p className="text-muted-foreground text-lg">
