...
export default function Sisterhood() {
    ...
    return (
        <div className="min-h-screen bg-[#FFF0E5] dark:bg-slate-900 text-slate-900 dark:text-slate-100 font-sans p-6 pb-20 -m-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-amber-200/40 rounded-full blur-[120px] -mr-40 -mt-20 pointer-events-none" />
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                {loading ? (
                    <div className="flex items-center justify-center h-64">
                        <div className="w-10 h-10 border-4 border-rose-200 border-t-amber-500 rounded-full animate-spin" />
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {matches.map((match, idx) => (
                            <motion.div
                                ...
                                className="bg-white rounded-[2.5rem] p-6 shadow-xl shadow-rose-100/50 border border-amber-50 relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300"
                            >
                                <div className="absolute top-0 right-0 w-32 h-32 bg-amber-50 rounded-full blur-2xl -mr-10 -mt-10 opacity-0 group-hover:opacity-100 transition-opacity" />
                                ...
                                <div className="relative z-10 flex flex-col items-center text-center">
                                    <div className="relative mb-4">
                                        ...
                                        <div className="absolute bottom-0 right-0 bg-white rounded-full p-1.5 shadow-md border border-amber-50">
                                            <Heart className="w-4 h-4 text-rose-500 fill-rose-500" />
                                        </div>
                                    </div>

                                    <div className="mb-1">
                                        <span className="bg-amber-50 text-rose-600 text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-rose-100">
                                            {match.reason}
                                        </span>
                                    </div>
                                    ...
                                    <div className="w-full bg-slate-50 rounded-2xl p-4 mb-6 text-left relative group-hover:bg-amber-50/50 transition-colors">
                                    ...
                                    <button className="w-full bg-rose-500 hover:bg-rose-600 text-white font-bold py-3 rounded-xl shadow-lg shadow-rose-200 flex items-center justify-center gap-2 transition-all active:scale-95">
